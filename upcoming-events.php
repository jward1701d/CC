<?php
	$dir = "issues/issue33/upcoming events/";
    $numPages = 75;
?>
<!DOCTYPE html>
<html lang="en">
...
$(document).ready(function() {
    ...
    $('#upcoming-events').wowBook({
        ...
        $("#cover").click(function(){
            $.wowBook("#upcoming-events").advance();
            
        });
        

        var book = $.wowBook("#upcoming-events");
