<?php
	$dir = "issues/issue33/yellow pages/";
    $numPages = 61;
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div id="container">
        ...
        <div id="main"  data-index = "#current">
            <div id='yellow-pages'>
                <div id='cover'>
                    <img src="<?php echo $dir;?>1.jpg" style = 'width: 100%; height: 100%;'>
                </div>
                <?php for( $i = 6; $i <= $numPages; $i++) : ?>
                    <div class='responsive feature'>
                        <img src="<?php echo $dir;?><?php echo $i;?>.jpg" style = 'width: 100%; height: 100%;'>
                    </div>
                <?php endfor; ?>
                 <div class='responsive feature'>
                        <img src="<?php echo $dir;?>76.jpg" style = 'width: 100%; height: 100%;'>
                    </div>
                     <div class='responsive feature'>
                        <img src="<?php echo $dir;?>77.jpg" style = 'width: 100%; height: 100%;'>
                    </div>
                     <div class='responsive feature'>
...
$(document).ready(function() {
    ...
    $('#yellow-pages').wowBook({
        ...
        $("#cover").click(function(){
            $.wowBook("#yellow-pages").advance();
            
        });

        var book = $.wowBook("#yellow-pages");
